...
namespace JiaHang.Projects.Admin.BLL.SysHelpInfoBLL
{
    public class SysHelpInfoBLL
    {
        ...
        public SysHelpInfoBLL(DataContext context)
        {
        ...
        /// </summary>
        /// <param name="id"></param>
        /// <param name="currentHelpId"></param>
        /// <returns></returns>
        public async Task<FuncResult> Delete(string id, string currentHelpId)
        {
            SysHelpInfo entity = await _context.SysHelpInfo.FindAsync(id);
            if (entity == null)
            {
            ...
            entity.DeleteFlag = 1;
            entity.DeleteBy = currentHelpId;
            entity.DeleteDate = DateTime.Now;
            _context.SysHelpInfo.Update(entity);
            await _context.SaveChangesAsync();
            return new FuncResult() { IsSuccess = true, Content = entity, Message = "删除成功" };
        }
        public async Task<FuncResult> Delete(string[] ids, string currentHelpId)
        {
