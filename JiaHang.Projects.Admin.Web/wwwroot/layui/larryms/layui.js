!function (r) {
    ...
    var p = document
        ...
        , f = function () {
            var e = p.currentScript ? p.currentScript.src : function () {
                for (var e, t = p.scripts, o = t.length - 1, n = o; n > 0; n--)
    ...
    n.prototype.cache = d,
        n.prototype.define = function (e, n) {
            ...
            return o && (n = e,
                e = []),
                layui["layui.all"] || !layui["layui.all"] && layui["layui.mobile"] ? r.call(t) : (t.use(e, r),
                    t)
        }
        ,
        n.prototype.use = function (o, e, t) {
            function n(e, t) {
                ...
                ("load" === e.type || o.test((e.currentTarget || e.srcElement).readyState)) && (d.modules[l] = t,
                    u.removeChild(c),
                    function e() {
            ...
            function r() {
                t.push(layui[l]),
                    o.length > 1 ? i.use(o.slice(1), e, t) : "function" == typeof e && e.apply(layui, t)
            }
            var i = this
                , a = d.dir = d.dir ? d.dir : f
                , u = p.getElementsByTagName("head")[0];
            o = "string" == typeof o ? [o] : o,
                window.jQuery && jQuery.fn.on && (i.each(o, function (e, t) {
            ...
            var l = o[0]
                , s = 0;
            if (t = t || [],
                d.host = d.host || (a.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0],
                0 === o.length || layui["layui.all"] && h[l] || !layui["layui.all"] && layui["layui.mobile"] && h[l])
                return r(),
                    i;
            if (d.modules[l])
                !function e() {
                ...
                y = y.replace(/^\{\/\}/, ""),
                    ...
                    u.appendChild(c),
                    !c.attachEvent || c.attachEvent.toString && c.attachEvent.toString().indexOf("[native code") < 0 || v ? c.addEventListener("load", function (e) {
                        n(e, y)
        ...
        n.prototype.link = function (t, o, e) {
            ...
            return r.rel = "stylesheet",
                r.href = t + (d.debug ? "?v=" + (new Date).getTime() : ""),
                r.media = "all",
                p.getElementById(u) || i.appendChild(r),
                "function" != typeof o ? n : (function e() {
                    return ++l > 1e3 * d.timeout / 100 ? m(t + " timeout") : void (1989 === parseInt(n.getStyle(p.getElementById(u), "width")) ? function () {
                        o()
                    }() : setTimeout(e, 100))
                }(),
                    n)
        ...
        n.prototype.factory = function (e) {
            if (layui[e])
                return "function" == typeof d.callback[e] ? d.callback[e] : null
        }
        ,
        ...
        n.prototype.extend = function (e) {
            ...
            e = e || {};
            for (var o in e)
                t[o] || t.modules[o] ? m("模块名 " + o + " 已被占用") : t.modules[o] = e[o];
            return t
        }
        ,
        ...
        n.prototype.data = function (e, t, o) {
            if (e = e || "layui",
                ...
                return "value" in t && (n[t.key] = t.value),
                    t.remove && delete n[t.key],
                    o[e] = JSON.stringify(n),
                    t.key ? n[t.key] : n
            }
        }
        ,
        ...
        n.prototype.sort = function (e, i, t) {
            ...
            return i ? (o.sort(function (e, t) {
                var o = /^-?\d+$/
                    , n = e[i]
                    , r = t[i];
                return o.test(n) && (n = parseFloat(n)),
                    o.test(r) && (r = parseFloat(r)),
                    n && !r ? 1 : !n && r ? -1 : n > r ? 1 : n < r ? -1 : 0
            }),
                t && o.reverse(),
                o) : o
        }
        ...
        n.prototype.event = n.event = function (e, t, n, o) {
            ...
            return o ? (d.event[u] = d.event[u] || {},
                d.event[u][l] = [o],
                this) : (layui.each(d.event[u], function (e, t) {
                    return "{*}" === l ? void layui.each(t, s) : ("" === e && layui.each(t, s),
                        void (l && e === l && layui.each(t, s)))
                }),
                    i)
        }
        ,
